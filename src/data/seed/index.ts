...
// A small demo dataset: one active, licensed CSV source that's already been
// synced once, one source still awaiting admin review (so its `active: false`
// + review_required constraint is visible in the demo), two canonical
// properties (one with two source records, showing provenance), and a few
// units in varying availability states.

export const seedRentalSources: RentalSource[] = [
  {
    id: "rsrc-1",
    name: "Example Property Group (CSV export)",
    source_type: "direct_property_manager",
    ...
    contact_name: "Example Property Group",
    contact_email: "data@example-property-group.test",
    notes: "Direct export from the property manager's own PMS — attested at registration.",
    active: true,
    last_synced_at: "2026-09-07T14:00:00Z",
    created_by: "u-landlord-1",
    created_at: "2026-09-01T00:00:00Z",
    updated_at: "2026-09-07T14:00:00Z",
  },
  {
    id: "rsrc-2",
    name: "Prospective Regional Listing Feed",
    ...
    contact_name: null,
    contact_email: "partnerships@example-listing-feed.test",
    notes: "Licensing terms still under legal review — cannot be activated until license_status changes.",
    active: false,
    last_synced_at: null,
    created_by: "u-landlord-1",
...
export const seedAggProperties: AggProperty[] = [
  {
    id: "aggp-1",
    property_name: "Midtown Apartments",
    property_type: "apartment_community",
    ...
    description: "A mid-rise community near downtown Springfield.",
    year_built: 2005,
    total_units: 48,
    amenities: ["Pool", "Fitness Center", "Washer/Dryer"],
    pet_policy: { dogs_allowed: true, cats_allowed: true },
    parking: "Surface lot",
    utilities: ["Water", "Trash"],
    photos: [],
    videos: [],
    website: "https://example-property-group.test/midtown",
    management_company: "Example Property Group",
    management_contact: { name: "Leasing Office", phone: "555-0100", email: "leasing@example-property-group.test" },
    primary_source_id: "rsrc-1",
    verification_status: "verified",
    trust_score: 96,
    quality_flags: [],
    last_verified: "2026-09-07T14:00:00Z",
    last_seen: "2026-09-07T14:00:00Z",
    active: true,
  ...
  },
  {
    ...
    latitude: 39.7456,
    longitude: -89.6934,
    neighborhood: "West Springfield",
    description: "Two-story townhomes with attached garages.",
    year_built: 2012,
    total_units: 24,
    amenities: ["Garage", "Yard"],
    pet_policy: { dogs_allowed: true, cats_allowed: false, notes: "Dogs under 40lbs only" },
    ...
    website: null,
    management_company: "Example Property Group",
    management_contact: { phone: "555-0100" },
    primary_source_id: "rsrc-1",
...
export const seedAggPropertySources: AggPropertySource[] = [
  {
    id: "aggps-1",
    agg_property_id: "aggp-1",
    source_id: "rsrc-1",
    source_property_id: "EPG-MID-01",
    source_url: "https://example-property-group.test/midtown",
    raw_data: { property_name: "Midtown Apartments", address: "123 Main Street" },
    is_primary: true,
    first_seen: "2026-09-01T00:05:00Z",
    last_seen: "2026-09-07T14:00:00Z",
    last_verified: "2026-09-07T14:00:00Z",
    created_at: "2026-09-01T00:05:00Z",
    updated_at: "2026-09-07T14:00:00Z",
  ...
  {
    id: "aggps-2",
    agg_property_id: "aggp-2",
    source_id: "rsrc-1",
    source_property_id: "EPG-OAK-01",
    source_url: null,
    raw_data: { property_name: "Oak Ridge Townhomes", address: "500 Oak Ridge Rd" },
    is_primary: true,
    first_seen: "2026-09-01T00:05:00Z",
    last_seen: "2026-09-07T14:00:00Z",
    last_verified: null,
...
export const seedAggUnits: AggUnit[] = [
  {
    id: "aggu-1",
    agg_property_id: "aggp-1",
    unit_number: "203",
    ...
    furnished: false,
    pets_allowed: { dogs_allowed: true, cats_allowed: true },
    parking: "Surface lot",
    utilities: ["Water", "Trash"],
  ...
  },
  {
    ...
    unit_amenities: [],
    photos: [],
    availability_status: "application_pending",
    primary_source_id: "rsrc-1",
    trust_score: 96,
    quality_flags: [],
    last_seen: "2026-09-07T14:00:00Z",
  ...
  },
  {
    ...
    lease_term: null,
    furnished: false,
    pets_allowed: { dogs_allowed: true, cats_allowed: false },
    parking: "Attached garage",
    utilities: [],
    unit_amenities: [],
    photos: [],
...
export const seedAggUnitSources: AggUnitSource[] = [
  { id: "aggus-1", agg_unit_id: "aggu-1", source_id: "rsrc-1", source_unit_id: "EPG-MID-01-203", source_url: null, raw_data: { unit_number: "203" }, is_primary: true, first_seen: "2026-09-01T00:05:00Z", last_seen: "2026-09-07T14:00:00Z", last_verified: "2026-09-07T14:00:00Z", created_at: "2026-09-01T00:05:00Z", updated_at: "2026-09-07T14:00:00Z" },
  { id: "aggus-2", agg_unit_id: "aggu-2", source_id: "rsrc-1", source_unit_id: "EPG-MID-01-115", source_url: null, raw_data: { unit_number: "115" }, is_primary: true, first_seen: "2026-09-01T00:05:00Z", last_seen: "2026-09-07T14:00:00Z", last_verified: "2026-09-07T14:00:00Z", created_at: "2026-09-01T00:05:00Z", updated_at: "2026-09-07T14:00:00Z" },
  { id: "aggus-3", agg_unit_id: "aggu-3", source_id: "rsrc-1", source_unit_id: "EPG-OAK-01-12", source_url: null, raw_data: { unit_number: "12" }, is_primary: true, first_seen: "2026-09-01T00:05:00Z", last_seen: "2026-09-07T14:00:00Z", last_verified: null, created_at: "2026-09-01T00:05:00Z", updated_at: "2026-09-07T14:00:00Z" },
];

export const seedAggFreshnessConfig: AggFreshnessConfig = {
  id: "default",
  needs_verification_days: 7,
  reduced_ranking_days: 14,
  auto_inactive_days: 30,
  duplicate_match_threshold: 0.72,
  updated_at: "2026-08-01T00:00:00Z",
};
